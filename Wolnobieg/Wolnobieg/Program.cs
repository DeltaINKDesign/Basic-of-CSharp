...
namespace Wolnobieg
{
    ...
    {
        public static bool CzyWolnobiezny(this Pojazd pojazd)
        {
            if (pojazd.Predkosc < 25)
            {
                return true;
            }
            return false;
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            ITuningowalny zmienna = (Car)pojazdy[0];
            zmienna.ZwiekszPredkosc(60);
            Console.WriteLine(pojazdy[0].CzyWolnobiezny());
            Console.WriteLine(pojazdy[1].CzyWolnobiezny());
